...
<template>
  <div class="w-full h-full flex flex-col justify-center bg-(--ui-bg)">
    <svg
    ...
    <div class="pl-[100px]">
      <p
        v-if="headline"
        class="uppercase text-[24px] text-(--ui-primary) mb-4 font-semibold"
      >
        {{ headline }}
      </p>
      <h1
      ...
      <p
        v-if="description"
        class="text-[32px] text-(--ui-text-muted) leading-tight w-[700px]"
      >
        {{ description }}
      </p>
    </div>
